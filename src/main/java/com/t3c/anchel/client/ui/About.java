...
public class About
{
	...
	private void initialize()
	{
		...
		lblNewLabel.setIcon(new ImageIcon(About.class.getResource("/com/t3c/anchel/client/utils/images/about/icon-01.png")));
		...
		panel_1.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Build details", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
